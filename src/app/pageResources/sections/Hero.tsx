    ...
    return <ContentWrapper Element="section" className="flex flex-row justify-between max-w-[1100px]">
        ...
        <div className="hidden lg:block">
            <ul className="py-5 w-[350px] flex flex-col">
                ...
                />
                <ProductHeroCardListItem alignment="end" margin-bottom={73} productName="Carteira de Dividendos"
                ...
                />
                <ProductHeroCardListItem alignment="start" productLogoSrc={py} htmlProductName={(
                                            <span>Código<span className="text-turquoise-200">.py</span></span>
                                            )}
                                         blurredLightDecorationStyle={{
                                             width: 188,
                                             height: 97,
        ...
        <li className="w-fit relative z-10"
            ...
            <div className="bg-grey-900 border rounded-[16px] border-grey-700">
                <div className="flex flex-row items-center">
                    <div className="flex justify-center items-center border rounded-[8px] border-grey-700 bg-c-black
                        w-[51px] h-[46px] ml-[13px]"
                    >
                        <Image src={props.productLogoSrc} alt={"Logo " + props.productName}/>
                    </div>
            ...
            {props.blurredLightDecorationStyle ?
                <BlurredLightProductCardDecoration {...props.blurredLightDecorationStyle}/>
                : null
            }
        </li>
    )
...
function BlurredLightProductCardDecoration(props : TBlurredLightProductCardDecoration) {
    return (
        <div style={{
