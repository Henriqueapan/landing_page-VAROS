...
export default function LogoInfiniteSlider(props: {
  "max-width"?: number;
  extraClassName?: string;
}) {
  return (
    <div
      className={handleClassName(props.extraClassName)}
...
function SliderLogoList() {
  return (
    <ul
      className="flex flex-shrink-0 items-center justify-center md:justify-start my-[28px] max-w-none
