...
export const handleStylization = (
  ...
  switch (stylization.type) {
    ...
    case "outlined":
      if (stylization.twColor === "gray")
        className += "border border-grey-800 bg-grey-900 text-grey-100";
      else className;
      break;
    case "blended":
      if (stylization.twColor === "green")
        className += "font-semibold bg-s-green/40 text-s-green";
      else className;
      break;
  }
